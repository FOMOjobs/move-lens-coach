...
export const DEMO_PANELS: { day: string; lab: string; values: LabValue[] }[] = [
  {
    ...
    values: [
      { code: "hgb", loinc: "718-7", name: "Hemoglobina", unit: "g/dl", value: 13.4, refLow: 13, refHigh: 17, refSource: "sheet" },
      { code: "ferrytyna", loinc: "2276-4", name: "Ferrytyna", unit: "µg/l", value: 41, refLow: 30, refHigh: 400, refSource: "sheet" },
      { code: "glukoza", loinc: "1558-6", name: "Glukoza na czczo", unit: "mg/dl", value: 94, refLow: 70, refHigh: 99, refSource: "sheet" },
      { code: "chol", loinc: "2093-3", name: "Cholesterol całkowity", unit: "mg/dl", value: 196, refLow: null, refHigh: 190, refSource: "sheet" },
      { code: "tsh", loinc: "3016-3", name: "TSH", unit: "µIU/ml", value: 2.1, refLow: 0.27, refHigh: 4.2, refSource: "sheet" },
      { code: "vitd", loinc: "1989-3", name: "Witamina D (25-OH)", unit: "ng/ml", value: 24, refLow: 30, refHigh: 50, refSource: "sheet" },
    ],
  },
  {
    day: "2026-02-03",
    lab: "Laboratorium Diagnostyka",
    values: [
      { code: "hgb", loinc: "718-7", name: "Hemoglobina", unit: "g/dl", value: 14.1, refLow: 13, refHigh: 17, refSource: "sheet" },
      { code: "ferrytyna", loinc: "2276-4", name: "Ferrytyna", unit: "µg/l", value: 68, refLow: 30, refHigh: 400, refSource: "sheet" },
      { code: "glukoza", loinc: "1558-6", name: "Glukoza na czczo", unit: "mg/dl", value: 91, refLow: 70, refHigh: 99, refSource: "sheet" },
      { code: "chol", loinc: "2093-3", name: "Cholesterol całkowity", unit: "mg/dl", value: 188, refLow: null, refHigh: 190, refSource: "sheet" },
      { code: "tsh", loinc: "3016-3", name: "TSH", unit: "µIU/ml", value: 1.8, refLow: 0.27, refHigh: 4.2, refSource: "sheet" },
    ],
  },
];
